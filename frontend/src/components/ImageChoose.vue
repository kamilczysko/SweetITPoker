<template>
    <div class='flex items-center justify-center bg-none'>
        ...
        <div class='flex justify-center w-3/5 align-middle cursor-pointer relative' v-on:click="toggle">
            ...
            <div v-show="isOpen" class='flex flex-wrap items-center justify-center gap-1 py-1 flex-shrink xs:w-[70vw] sm:min-w-[50vw] 2xl:min-w-[45vw] bg-bg2 rounded-xl bg-opacity-70 absolute'
