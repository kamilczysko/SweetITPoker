<template>
    <div class='flex items-center justify-center bg-none'>
        ...
        <div class='flex justify-center w-3/5 align-middle cursor-pointer relative' v-on:click="toggle">
            ...
            <div v-show="isOpen" class='flex flex-wrap gap-2 flex-shrink sm:w-[40vw] 2xl:w-full bg-bg2 rounded-xl p-1 bg-opacity-70 absolute'
                v-on:mouseleave="hide">
                <div v-for=" img, index in images()"
                    class='rounded-full w-11 h-11 overflow-hidden hover: shadow-md hover:shadow-bg3 focus:scale-xl'
