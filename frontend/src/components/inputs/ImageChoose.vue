<template>
    <div class='flex items-center justify-center bg-none'>
        ...
        <div class='flex justify-center w-1/6 align-middle cursor-pointer relative' v-on:click="toggle">
            ...
            <div v-show="isOpen" class='flex flex-wrap items-center justify-center gap-1 xs:py-0 lg:py-1 flex-shrink xs:w-[70vw] lg:w-[40vw] bg-bg2 rounded-xl bg-opacity-70 absolute lg:-right-16 xs:-right-[10vw] '
