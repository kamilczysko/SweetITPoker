<template>
    <div class='cursor-pointer z-40 rounded-md aspect-card lg:min-w-[7vw] lg:w-[7vw] xs:min-w-[20vw] xs:w-[20vw] sm:min-w-[10vw] sm:w-[10vw] md:min-w-[12vw] md:w-[12vw]' :class="{['shadow-highlight brightness-125']:isSelected}">
        <div v-if="isVisible"
